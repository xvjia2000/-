			...
			<div class="col-md-7 split min_h_500">
						...
						<div class="bd-example">
							<div id="carouselExampleCaptions" class="carousel slide"
								...
								<div class="carousel-inner">
									...
									<div class="carousel-item">
										<img src="/pic/3.jpeg" class="d-block w-100" alt="...">
										<div class="carousel-caption d-none d-md-block"></div>
									</div>
								</div>
						...
						<c:forEach items="${hotArticles}" var="h">
							<ul class="list-unstyled">
								<li class="media"><img src="/pic/${h.picture }"
									class="mr-3" alt="..." style="height: 124px; width: 190px">
									<div class="media-body">
										...
										<span style="color: #666"> ${h.user.nickname } &nbsp; <fmt:formatDate
												value="${h.updated }" pattern="yyyy-MM-dd HH:mm:ss" />
										</span>
									</div></li>
								<hr />
						</c:forEach>
				...
				<c:if test="${article.channelId!=null}">
					<div>
						...
						<div id="category">
							<ul class="nav">
								<li class="nav-item" id="cate"><a class="nav-link"
						...
						<script type="text/javascript">
							function page(pageNum) {
								if (pageNum==0) {
									...
									location.href =  "?channelId=${article.channelId }&categoryId=${article.categoryId }&pageNum="+pageNum; 
