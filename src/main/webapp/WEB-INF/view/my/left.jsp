	...
	<div class="list-group">
		<ul class="list-group">
			...
			<li class="list-group-item  text-center"><a class="channel"
				...
				data="/article/selectsByUser?userId=${sessionScope.user.id}">我的文章
			</a></li>
			<li class="list-group-item  text-center"><a class="channel"
			...
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/article/head"
				class="list-group-item">上传头像</a></li>
			...
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/toCollectList"
			...
			<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/article/publishPic"
				class="list-group-item">发布图片集</a></li>
