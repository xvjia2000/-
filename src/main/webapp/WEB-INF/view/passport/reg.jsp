				...
				<div class="card" style="width: 22rem;">
					...
					<span style="color: red;">${error }</span>
						...
						<form action="/passport/reg" method="post" id="form1">
							...
							<div class="form-group">
								<label for="repassword"> 生日：</label> <input type="date"
									name="date1" class="form-control" >
							</div>

							<div class="form-group">
								<label for="repassword"> 重复密码：</label> <input type="password"
									name="repassword" class="form-control" id="repassword">
							</div>


							<div class="form-group form-inline">
								性别 <input type="radio" name="gender" value="0"
									class="form-control" checked="checked"> ♂ <input
									type="radio" name="gender" value="1" class="form-control">♀
							</div>
